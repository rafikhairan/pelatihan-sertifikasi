...
@section('content')
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">Add Platform</h1>
        ...
        <form action="{{ route('platforms.store') }}" method="POST">
          ...
          <div class="modal-body p-4">
            <div class="mb-3">
              <label for="platform" class="form-label">Name</label>
  ...
  <div class="modal fade" id="delete-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">Delete Platform</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action="" method="POST" id="delete-form">
          ...
          <div class="modal-body p-4">
            <div class="mb-3 text-center">
              ...
              <span class="fs-4 d-block">Are you sure you want to delete this platform?</span>
            </div>
            <div class="d-grid">
  ...
  <div class="modal fade" id="edit-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">Edit Platform</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action="{{ route('platforms.store') }}" method="POST" id="edit-form">
          @csrf
          @method('PUT')
          <div class="modal-body p-4">
            <div class="mb-3">
              <label for="edit-platform" class="form-label">Name</label>
...
@push('scripts')
  <script>
    ...
    function bindingDelete(id) {
      $('#delete-form').attr('action', `{{ url('platforms') }}/${id}`)
    }

    function bindingEdit(id, name) {
      $('#edit-form').attr('action', `{{ url('platforms') }}/${id}`)
      $('#edit-platform').attr('value', name)
    }
  </script>
@endpush